...
2. run bitmonixd with -printalert or -sendalert like this:
   /path/to/bitmonixd -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.bitmonix.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Bitmonix Core:0.12.0.58/"));
