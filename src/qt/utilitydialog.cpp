    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitmonix-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Bitmonix in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BXC, 0.1 BXC, 1 BXC and 10 BXC -- sort of like the paper money you use every day.</li> \
