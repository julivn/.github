    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BXC-light"), QVariant("light"));
    ui->theme->addItem(QString("BXC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BXC-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("BXC-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("BXC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BXC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BXC-traditional"), QVariant("trad"));
