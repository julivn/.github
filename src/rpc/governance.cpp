...
UniValue gobject(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp  ||
        ...
        throw std::runtime_error(
                ...
                "  vote-conf          - Vote on a governance object by masternode configured in bitmonix.conf\n"
    ...
    */
    ...
    if(strCommand == "vote-conf")
    {
        ...
        if(!fMnFound) {
            ...
            resultsObj.push_back(Pair("bitmonix.conf", statusObj));
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    /* Bitmonix features */
    { "bitmonix",               "getgovernanceinfo",      &getgovernanceinfo,      true,  {} },
    { "bitmonix",               "getsuperblockbudget",    &getsuperblockbudget,    true,  {"index"} },
    { "bitmonix",               "gobject",                &gobject,                true,  {} },
    { "bitmonix",               "voteraw",                &voteraw,                true,  {} },
