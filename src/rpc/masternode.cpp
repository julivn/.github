...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Bitmonix address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "bitmonix",               "masternode",             &masternode,             true,  {} },
    { "bitmonix",               "masternodelist",         &masternodelist,         true,  {} },
    { "bitmonix",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "bitmonix",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "bitmonix",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "bitmonix",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
