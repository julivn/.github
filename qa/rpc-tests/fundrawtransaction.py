...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid bitmonix address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid bitmonix address" in e.error['message'])
