...
This mechanism has been integrated into Bitcore-Node-Bitmonix which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitmonixpay/insight-api-bitmonix#web-socket-api](https://github.com/bitmonixpay/insight-api-bitmonix#web-socket-api)
* API: [https://github.com/bitmonixpay/insight-api-bitmonix#instantsend-transactions](https://github.com/bitmonixpay/insight-api-bitmonix#instantsend-transactions)
...
By default, the Bitmonix Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bitmonix Core daemon:
