...
This document provides guidelines for internationalization of the Bitmonix Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitmonix_en.ts` remains unchanged.
